  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="text-2xl sm:text-4xl text-center font-bold mb-6 px-8 sm:px-24 py-2 rounded-md"
      >
        Get in Touch
      </motion.h1>
      ...
      <motion.form
        onSubmit={handleSubmit}
        className="w-full max-w-xs sm:max-w-md p-4 sm:p-6 bg-gray-800 bg-opacity-90 dark:bg-opacity-80 rounded-lg shadow-lg border flex flex-col gap-4 sm:gap-6 backdrop-blur-md"
        initial={{ scale: 0.8, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        transition={{ duration: 0.5 }}
      >
        <input
          ...
          value={formData.name}
          onChange={handleChange}
          className="w-full p-2 sm:p-3 rounded-lg bg-gray-700 text-white focus:outline-none"
        />
        <input
          type="email"
          name="email"
        ...
        <button
          type="submit"
          className="w-full p-2 sm:p-3 bg-primary hover:bg-blue-600 dark:hover:bg-blue-400 rounded-lg font-bold transition-transform transform hover:scale-105"
        >
          Send Message
        </button>
      </motion.form>
    ...
    //   style={{ backgroundImage: `url(${contact})`, backgroundSize: "cover", backgroundPosition: "center", height: "100%", width: "100%" }}
    // >
    //   <motion.h1
    //     initial={{ opacity: 0, y: -20 }}
    //     animate={{ opacity: 1, y: 0 }}
